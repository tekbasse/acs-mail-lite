...
set mailbox {{or97.net}inbox}
set mailbox_host {{or97.net}}
#set mailbox_host $mailbox
#set mailbox_name {}
#set mailbox_mt {{or97.net}}
#set mailbox {{or97.net}zippy}
ns_log Notice "0. mailbox '${mailbox}'"
#set user "testimap1@or97.net"
...
#set content [acs_mail_lite::imap_conn_go -host "{{/$ho/ssl}mail/INBOX}" -password "13ulbio" -user "testimap1"]
append content \n \n [clock seconds]
